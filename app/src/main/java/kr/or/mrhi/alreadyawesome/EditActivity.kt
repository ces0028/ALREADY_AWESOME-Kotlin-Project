    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnEditEdit.setOnClickListener {
            ...
            // 모든 패턴이 맞을 경우,
                ...
                val updateMember = Member(member?.memberKey, userId, password, name, birthDate, gender, phone, email, member?.rate!!)
                val updateFlag = dbHelper.updateMember(updateMember)
                if (updateFlag) {
                ...
                Log.d("kr.or.mrhi", "EditActivity updateMember(SQLite) $updateFlag")
            }
        }
